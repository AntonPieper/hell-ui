  ...
  template: `
    <article class="hd-prose">
      ...
      <ul>
        ...
        <li>Two cases deliberately fall back to appending. Tabbing into the display selects the whole number the way any text field does, but a keypad key then adds a digit rather than replacing everything — typing still replaces the selection, because that is the field's own behaviour. Writing a new <code>[value]</code> from outside also drops the tracked caret, since the number the caret pointed into is gone.</li>
