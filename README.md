...
| Data table and adapters | Experimental | `@hell-ui/angular/data-table`, `@hell-ui/angular/table-tanstack`, `@hell-ui/angular/table-virtual`, `@hell-ui/angular/table-cdk` | Simple native data table, TanStack Table adapter, TanStack Virtual adapter, and CDK Table skin adapter are available; keep adapter-specific engines behind their entrypoints |
