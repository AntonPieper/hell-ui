...
| 9 | `main-TXJAYAOH.js` | 21.44 kB | Docs app shell bootstrap | `projects/hell-docs/src/app/app.ts` (19.60 kB)<br>`projects/hell-docs/src/app/app.config.ts` (74 B)<br>`projects/hell-docs/src/main.ts` (35 B) |
...
| 8 | `chunk-VB7QQFF5.js` | 35.83 kB | Docs search index (loaded on search open) | `projects/hell-docs/src/app/docs-search-index.ts` (35.60 kB) |
...
| ---: | --- | ---: | --- | --- |
| 1 | `data-table.page-FCQJVP2N.css` | 3.98 kB | Table utilities docs page (`/components/data-table`) | within warning |
| 2 | `code-editor.page-F4WQTVYL.css` | 994 B | Code Editor docs page (`/components/code-editor`) | within warning |
| 3 | `example-boundary-keeps-siblings-interactive.example-TQC5YXT6.css` | 531 B | Flyout docs page (`/components/flyout`) | within warning |
