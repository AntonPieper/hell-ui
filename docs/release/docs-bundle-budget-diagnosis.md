...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 905.25 kB | 500.00 kB | 1050.00 kB | accepted warning: 405.25 kB over; accepted ceiling: 910.00 kB; owner: Docs shell / global styles; follow-up: lazy-route import graph guard |
...
| 8 | `main-EW426T5D.js` | 22.21 kB | Docs app shell bootstrap | `src/app/app.ts` (19.90 kB)<br>`src/app/app.config.ts` (74 B)<br>`src/main.ts` (35 B) |
...
| 5 | `chunk-QHHXOEMF.js` | 50.76 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (50.53 kB) |
