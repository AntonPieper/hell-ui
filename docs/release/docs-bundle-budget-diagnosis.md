...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 908.36 kB | 500.00 kB | 1050.00 kB | accepted warning: 408.36 kB over; accepted ceiling: 910.00 kB; owner: Docs shell / global styles; follow-up: lazy-route import graph guard |
...
| 7 | `chunk-7RJQIKFB.js` | 24.46 kB | Docs shell primitive dependencies | `../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-menu.mjs` (15.56 kB)<br>`../../packages/angular/menu/menu.ts` (8.09 kB) |
| 8 | `chunk-GQVPRI3L.js` | 22.62 kB | Docs shell primitive dependencies | `../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-select.mjs` (11.23 kB)<br>`../../packages/angular/select/select.ts` (10.39 kB) |
| 9 | `main-M6SPNF6E.js` | 22.05 kB | Docs app shell bootstrap | `src/app/app.ts` (19.76 kB)<br>`src/app/app.config.ts` (74 B)<br>`src/main.ts` (35 B) |
| 10 | `chunk-OFJHAIAE.js` | 22.02 kB | Docs shell primitive dependencies | `../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-portal.mjs` (21.32 kB)<br>`../../node_modules/.pnpm/@angular+cdk@21.2.11_@angular+common@21.2.13_@angular+core@21.2.13_@angular+compiler@21_04df65e2704088424dcd37e685ec6dc2/node_modules/@angular/cdk/fesm2022/cdk.mjs` (23 B) |
| 11 | `chunk-X23PVN3R.js` | 20.50 kB | Shared initial dependency | `../../packages/angular/toast/toast.ts` (18.55 kB)<br>`../../packages/angular/toast/toast-stack.runtime.ts` (1.44 kB) |
...
| 3 | `chunk-GT4QFNT5.js` | 197.72 kB | Table docs page (`/components/table`) | `../../node_modules/.pnpm/@tanstack+table-core@8.21.3/node_modules/@tanstack/table-core/build/lib/index.mjs` (52.71 kB)<br>`src/app/pages/components/table/examples/tanstack-shell.example.ts?raw` (22.81 kB)<br>`../../node_modules/.pnpm/@tanstack+virtual-core@3.17.0/node_modules/@tanstack/virtual-core/dist/esm/index.js` (20.83 kB) |
...
| 5 | `chunk-6OLUSAHZ.js` | 51.76 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (51.53 kB) |
| 6 | `chunk-DJLFY2RU.js` | 46.13 kB | Combobox docs page (`/components/combobox`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (17.12 kB)<br>`../../packages/angular/combobox/combobox.ts` (11.27 kB)<br>`src/app/pages/components/combobox/combobox.page.ts` (6.30 kB) |
| 7 | `chunk-N4USGMOB.js` | 35.44 kB | Audio Player docs page (`/components/audio-player`) | `../../packages/angular/audio-player/audio-player.ts` (15.82 kB)<br>`src/app/pages/components/audio-player/audio-player.page.ts` (8.77 kB)<br>`../../packages/angular/features/audio-transcript/audio-transcript.ts` (2.67 kB) |
| 8 | `chunk-UPJ6AWKW.js` | 33.60 kB | Date Picker docs page (`/components/date-picker`)<br>Date Input docs page (`/components/date-input`)<br>Field docs page (`/components/field`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-date-picker.mjs` (18.43 kB)<br>`../../packages/angular/date-picker/date-picker.ts` (12.54 kB)<br>`../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-date-time.mjs` (2.01 kB) |
| 9 | `chunk-UHZHE7CG.js` | 32.80 kB | Time Input docs page (`/components/time-input`) | `../../packages/angular/time-input/time-input.ts` (14.69 kB)<br>`src/app/pages/components/time-input/time-input.page.ts` (6.34 kB)<br>`src/app/pages/components/time-input/examples/examples.example.ts?raw` (2.09 kB) |
| 10 | `chunk-ESI33TAC.js` | 31.30 kB | Pdf Viewer docs page (`/components/pdf-viewer`) | `../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.ts` (13.12 kB)<br>`../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.runtime.ts` (9.27 kB)<br>`../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.adapter.ts` (5.13 kB) |
| 11 | `chunk-YIT432DU.js` | 30.86 kB | Accessibility guide page | `src/app/pages/accessibility/accessibility.page.ts` (30.35 kB) |
| 12 | `chunk-OATJ54W6.js` | 30.24 kB | Dialog docs page (`/components/dialog`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-dialog.mjs` (9.49 kB)<br>`src/app/pages/components/dialog/dialog.page.ts` (5.65 kB)<br>`../../packages/angular/dialog/dialog.ts` (5.54 kB) |
...
| --- | --- | --- | --- |
| Initial bundle exceeds 500 kB by 408.36 kB | Static imports from `main` pull router/runtime plus docs-shell controls; `styles.css` globally imports Tailwind and explicit Hell entrypoint styles. Top chunks: `styles-D6T5XUJD.css`, `chunk-CUNHFVUL.js`, `chunk-RT2N5KKY.js`, `chunk-PE5SQNR4.js`, `chunk-BG3HXG3N.js`. | Docs shell / global styles | Accepted by the docs budget policy (lazy-route import graph guard; expires when: Any build that exceeds the accepted ceiling, reaches the initial maximumError threshold, or reopens the production-readiness budget decision.); the architecture guard blocks future eager imports across docs route boundaries, and any undocumented new warning is a regression. |
