...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 874.99 kB | 500.00 kB | 1050.00 kB | accepted warning: 374.99 kB over; accepted ceiling: 875.00 kB; owner: Docs shell / global styles; follow-up: lazy-route import graph guard |
...
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| Initial bundle | 874.99 kB | 875.00 kB | Docs shell / global styles | The current warning is the accepted internal-beta docs-shell baseline: Angular runtime/router, global Tailwind, Hell composite/table CSS, app-shell/search/menu/select navigation UI, top-level icons, Button and Toast recipe utilities, and tailwind-merge. Toast structural CSS stays lazy, but its migrated Part Recipe utilities are compiled in the docs shell so live Toast docs exercise the recipe path. Heavy feature examples and raw source previews stay behind lazy docs route boundaries. This acceptance is not permission for unrelated eager imports. | `docs/release/docs-bundle-budget-diagnosis.md` | lazy-route import graph guard | Any build that exceeds the accepted ceiling, reaches the initial maximumError threshold, or reopens the production-readiness budget decision. |

## Largest initial chunks

| Rank | Chunk | Size | Owner | Largest inputs |
| ---: | --- | ---: | --- | --- |
| 1 | `styles-QUWIMJQW.css` | 201.46 kB | Docs global stylesheet (`styles.css`) | `src/styles.css` (201.46 kB)<br>`angular:styles/global:styles` (0 B) |
...
| 9 | `main-SK2CTDHJ.js` | 22.32 kB | Docs app shell bootstrap | `src/app/app.ts` (19.84 kB)<br>`src/app/shared/lazy-global-style.ts` (175 B)<br>`src/app/app.config.ts` (74 B) |
| 10 | `chunk-GWTHUFP2.js` | 22.13 kB | Docs shell primitive dependencies | `../../node_modules/.pnpm/ng-primitives@0.117.2_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-select.mjs` (10.77 kB)<br>`../../packages/angular/select/select.ts` (10.36 kB) |
...
| 3 | `chunk-EC7DKILI.js` | 193.79 kB | Table docs page (`/components/table`) | `../../node_modules/.pnpm/@tanstack+table-core@8.21.3/node_modules/@tanstack/table-core/build/lib/index.mjs` (52.71 kB)<br>`src/app/pages/components/table/examples/tanstack-shell.example.ts?raw` (22.81 kB)<br>`../../node_modules/.pnpm/@tanstack+virtual-core@3.17.0/node_modules/@tanstack/virtual-core/dist/esm/index.js` (20.83 kB) |
...
| 5 | `chunk-QZXAS2MT.js` | 128.27 kB | Code Editor docs page (`/components/code-editor`) | `../../node_modules/.pnpm/@lezer+javascript@1.5.4/node_modules/@lezer/javascript/dist/index.js` (77.72 kB)<br>`../../node_modules/.pnpm/@lezer+lr@1.4.10/node_modules/@lezer/lr/dist/index.js` (26.49 kB)<br>`../../node_modules/.pnpm/@codemirror+autocomplete@6.20.1/node_modules/@codemirror/autocomplete/dist/index.js` (7.54 kB) |
| 6 | `chunk-VDXXA2WM.js` | 42.20 kB | Combobox docs page (`/components/combobox`) | `../../node_modules/.pnpm/ng-primitives@0.117.2_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (16.68 kB)<br>`../../packages/angular/combobox/combobox.ts` (11.30 kB)<br>`src/app/pages/components/combobox/combobox.page.ts` (4.63 kB) |
| 7 | `chunk-2SAE32WM.js` | 42.11 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (41.89 kB) |
| 8 | `chunk-HNKKQ4TF.js` | 32.82 kB | Audio Player docs page (`/components/audio-player`) | `../../packages/angular/audio-player/audio-player.ts` (15.82 kB)<br>`src/app/pages/components/audio-player/audio-player.page.ts` (7.38 kB)<br>`../../packages/angular/features/audio-transcript/audio-transcript.ts` (2.67 kB) |
| 9 | `chunk-7ND673VW.js` | 32.41 kB | Date Input docs page (`/components/date-input`)<br>Date Picker docs page (`/components/date-picker`)<br>Field docs page (`/components/field`) | `../../node_modules/.pnpm/ng-primitives@0.117.2_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-date-picker.mjs` (18.10 kB)<br>`../../packages/angular/date-picker/date-picker.ts` (11.66 kB)<br>`../../node_modules/.pnpm/ng-primitives@0.117.2_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-date-time.mjs` (2.01 kB) |
| 10 | `chunk-36CYUH2F.js` | 30.85 kB | Pdf Viewer docs page (`/components/pdf-viewer`) | `../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.ts` (12.70 kB)<br>`../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.runtime.ts` (9.27 kB)<br>`../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.adapter.ts` (5.13 kB) |
| 11 | `chunk-L65TVUJL.js` | 30.64 kB | Accessibility guide page | `src/app/pages/accessibility/accessibility.page.ts` (30.20 kB) |
| 12 | `chunk-ES3KQFTF.js` | 30.36 kB | Time Input docs page (`/components/time-input`) | `../../packages/angular/time-input/time-input.ts` (14.64 kB)<br>`src/app/pages/components/time-input/time-input.page.ts` (5.27 kB)<br>`src/app/pages/components/time-input/examples/examples.example.ts?raw` (2.09 kB) |
...
| --- | --- | --- | --- |
| Initial bundle exceeds 500 kB by 374.99 kB | Static imports from `main` pull router/runtime plus docs-shell controls; `styles.css` globally imports Tailwind and explicit Hell entrypoint styles. Top chunks: `styles-QUWIMJQW.css`, `chunk-CUNHFVUL.js`, `chunk-QYRAO7AW.js`, `chunk-JIAXPF6B.js`, `chunk-FH3ETKZN.js`. | Docs shell / global styles | Accepted by the docs budget policy (lazy-route import graph guard; expires when: Any build that exceeds the accepted ceiling, reaches the initial maximumError threshold, or reopens the production-readiness budget decision.); the architecture guard blocks future eager imports across docs route boundaries, and any undocumented new warning is a regression. |
