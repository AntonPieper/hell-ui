...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 865.21 kB | 500.00 kB | 1050.00 kB | accepted warning: 365.21 kB over; accepted ceiling: 870.00 kB; owner: Docs shell / global styles; follow-up: lazy-route import graph guard |
...
| --- | ---: | ---: | --- | --- | --- | --- | --- |
| Initial bundle | 865.21 kB | 870.00 kB | Docs shell / global styles | The current warning is the accepted internal-beta docs-shell baseline: Angular runtime/router, global Tailwind, Hell composite/table CSS, app-shell/search/menu/select navigation UI, top-level icons, Button recipe utilities, and tailwind-merge. Heavy feature examples and raw source previews stay behind lazy docs route boundaries. This acceptance is not permission for unrelated eager imports. | `docs/release/docs-bundle-budget-diagnosis.md` | lazy-route import graph guard | Any build that exceeds the accepted ceiling, reaches the initial maximumError threshold, or reopens the production-readiness budget decision. |

## Largest initial chunks

| Rank | Chunk | Size | Owner | Largest inputs |
| ---: | --- | ---: | --- | --- |
| 1 | `styles-QB5CVOXQ.css` | 205.49 kB | Docs global stylesheet (`styles.css`) | `src/styles.css` (205.49 kB)<br>`angular:styles/global:styles` (0 B) |
...
| 8 | `main-AOOSRTML.js` | 21.98 kB | Docs app shell bootstrap | `src/app/app.ts` (19.71 kB)<br>`src/app/app.config.ts` (74 B)<br>`src/main.ts` (35 B) |
...
| 3 | `chunk-YQEEXQVQ.js` | 193.17 kB | Table docs page (`/components/table`) | `../../node_modules/.pnpm/@tanstack+table-core@8.21.3/node_modules/@tanstack/table-core/build/lib/index.mjs` (52.71 kB)<br>`src/app/pages/components/table/examples/tanstack-shell.example.ts?raw` (22.81 kB)<br>`../../node_modules/.pnpm/@tanstack+virtual-core@3.17.0/node_modules/@tanstack/virtual-core/dist/esm/index.js` (20.83 kB) |
...
| 6 | `chunk-UW3KUYYC.js` | 38.96 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (38.73 kB) |
| 7 | `chunk-JP765HXO.js` | 38.73 kB | Combobox docs page (`/components/combobox`) | `../../node_modules/.pnpm/ng-primitives@0.117.2_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (16.68 kB)<br>`../../packages/angular/combobox/combobox.ts` (8.60 kB)<br>`src/app/pages/components/combobox/combobox.page.ts` (3.90 kB) |
...
| 11 | `chunk-VKJ2KD24.js` | 30.33 kB | Time Input docs page (`/components/time-input`) | `../../packages/angular/time-input/time-input.ts` (14.64 kB)<br>`src/app/pages/components/time-input/time-input.page.ts` (5.27 kB)<br>`src/app/pages/components/time-input/examples/examples.example.ts?raw` (2.09 kB) |
| 12 | `chunk-T3EL3DB5.js` | 28.71 kB | Dialog docs page (`/components/dialog`) | `../../node_modules/.pnpm/ng-primitives@0.117.2_b3a3993826153d8d04b6cf59c44813bf/node_modules/ng-primitives/fesm2022/ng-primitives-dialog.mjs` (9.48 kB)<br>`src/app/pages/components/dialog/dialog.page.ts` (4.38 kB)<br>`../../packages/angular/dialog/dialog.ts` (3.74 kB) |
