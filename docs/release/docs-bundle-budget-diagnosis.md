...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 824.27 kB | 500.00 kB | 1050.00 kB | accepted warning: 324.27 kB over; accepted ceiling: 830.00 kB; owner: Docs shell / global styles; follow-up: HELL-050 static guard |
...
| ---: | --- | ---: | --- | --- |
| 1 | `styles-E2EGOTZ5.css` | 191.75 kB | Docs global stylesheet (`styles.css`) | `projects/hell-docs/src/styles.css` (191.74 kB)<br>`angular:styles/global:styles` (0 B) |
...
| 4 | `chunk-EKV2Q5JZ.js` | 74.28 kB | Docs search / omnibar shell | `node_modules/.pnpm/@angular+cdk@21.2.11_@angular+common@21.2.13_@angular+core@21.2.13_@angular+compiler@21_04df65e2704088424dcd37e685ec6dc2/node_modules/@angular/cdk/fesm2022/_overlay-module-chunk.mjs` (39.50 kB)<br>`dist/hell/fesm2022/hell-ui-angular-omnibar.mjs` (33.66 kB)<br>`node_modules/.pnpm/@angular+cdk@21.2.11_@angular+common@21.2.13_@angular+core@21.2.13_@angular+compiler@21_04df65e2704088424dcd37e685ec6dc2/node_modules/@angular/cdk/fesm2022/_test-environment-chunk.mjs` (138 B) |
...
| 11 | `chunk-ML5M7US6.js` | 17.79 kB | Docs toast host | `dist/hell/fesm2022/hell-ui-angular-toast.mjs` (17.34 kB) |
| 12 | `chunk-U2EAUKY5.js` | 16.54 kB | Docs app-shell layout | `dist/hell/fesm2022/hell-ui-angular-app-shell.mjs` (16.17 kB)<br>`node_modules/.pnpm/@angular+cdk@21.2.11_@angular+common@21.2.13_@angular+core@21.2.13_@angular+compiler@21_04df65e2704088424dcd37e685ec6dc2/node_modules/@angular/cdk/fesm2022/layout.mjs` (0 B) |
...
| 5 | `chunk-F5FWFDBZ.js` | 128.03 kB | Code Editor docs page (`/components/code-editor`) | `node_modules/.pnpm/@lezer+javascript@1.5.4/node_modules/@lezer/javascript/dist/index.js` (77.72 kB)<br>`node_modules/.pnpm/@lezer+lr@1.4.10/node_modules/@lezer/lr/dist/index.js` (26.49 kB)<br>`node_modules/.pnpm/@codemirror+autocomplete@6.20.1/node_modules/@codemirror/autocomplete/dist/index.js` (7.54 kB) |
| 6 | `chunk-E6WCWYZX.js` | 51.85 kB | Table utilities docs page (`/components/data-table`)<br>Accessibility guide page | `dist/hell/fesm2022/hell-ui-angular-table.mjs` (51.08 kB) |
| 7 | `chunk-53DF53JY.js` | 48.62 kB | Audio Player docs page (`/components/audio-player`) | `dist/hell/fesm2022/hell-ui-angular-audio-player.mjs` (34.41 kB)<br>`projects/hell-docs/src/app/pages/components/audio-player/audio-player.page.ts` (7.13 kB)<br>`dist/hell/fesm2022/hell-ui-angular-features-audio-transcript.mjs` (2.83 kB) |
| 8 | `chunk-DQ3W7V3M.js` | 40.79 kB | Combobox docs page (`/components/combobox`) | `node_modules/.pnpm/ng-primitives@0.117.2_@angular+cdk@21.2.11_@angular+common@21.2.13_@angular+core@21.2.1_299399a25444f37ea31a0eb7bc8bafde/node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (16.69 kB)<br>`dist/hell/fesm2022/hell-ui-angular-combobox.mjs` (10.91 kB)<br>`projects/hell-docs/src/app/pages/components/combobox/combobox.page.ts` (3.90 kB) |
| 9 | `chunk-2EVOQP2B.js` | 39.13 kB | Docs search index (loaded on search open) | `projects/hell-docs/src/app/docs-search-index.ts` (38.90 kB) |
| 10 | `chunk-6JC4AIJB.js` | 34.86 kB | Time Input docs page (`/components/time-input`) | `dist/hell/fesm2022/hell-ui-angular-time-input.mjs` (20.60 kB)<br>`projects/hell-docs/src/app/pages/components/time-input/time-input.page.ts` (4.39 kB)<br>`projects/hell-docs/src/app/pages/components/time-input/examples/examples.example.ts?raw` (2.07 kB) |
| 11 | `chunk-7K5RR4HF.js` | 31.49 kB | Dialog docs page (`/components/dialog`) | `node_modules/.pnpm/ng-primitives@0.117.2_@angular+cdk@21.2.11_@angular+common@21.2.13_@angular+core@21.2.1_299399a25444f37ea31a0eb7bc8bafde/node_modules/ng-primitives/fesm2022/ng-primitives-dialog.mjs` (9.48 kB)<br>`dist/hell/fesm2022/hell-ui-angular-dialog.mjs` (7.23 kB)<br>`projects/hell-docs/src/app/pages/components/dialog/dialog.page.ts` (4.38 kB) |
| 12 | `chunk-UHAPYHHN.js` | 30.67 kB | Pdf Viewer docs page (`/components/pdf-viewer`) | `dist/hell-pdf-viewer/fesm2022/hell-ui-pdf-viewer.mjs` (29.93 kB) |
...
| 4 | `example-boundary-keeps-siblings-interactive.example-LJC4GFXI.css` | 876 B | Flyout docs page (`/components/flyout`) | within warning |
...
| --- | --- | --- | --- |
| Initial bundle exceeds 500 kB by 324.27 kB | Static imports from `main` pull router/runtime plus docs-shell controls; `styles.css` globally imports Tailwind and `@hell-ui/angular/styles/composites`. Top chunks: `styles-E2EGOTZ5.css`, `chunk-MWRJDVZP.js`, `chunk-5TBVP3O2.js`, `chunk-EKV2Q5JZ.js`, `chunk-ZHYHX7L7.js`. | Docs shell / global styles | Accepted by the docs budget policy (HELL-050 static guard); HELL-050 guards future eager imports across docs route boundaries, and any undocumented new warning is a regression. |
