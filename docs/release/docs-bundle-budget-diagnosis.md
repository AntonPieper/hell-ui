...
| 2 | `chunk-DnhqLsC7.js` | 410.61 kB | PDF viewer feature (`pdfjs-dist`) | `../../node_modules/.pnpm/pdfjs-dist@5.6.205/node_modules/pdfjs-dist/build/pdf.mjs` (409.32 kB) |
| 3 | `chunk-sscdwbkh.js` | 197.94 kB | Table docs page (`/components/table`) | `../../node_modules/.pnpm/@tanstack+table-core@8.21.3/node_modules/@tanstack/table-core/build/lib/index.mjs` (53.02 kB)<br>`src/app/pages/components/table/examples/tanstack-shell.example.ts?raw` (22.94 kB)<br>`../../node_modules/.pnpm/@tanstack+virtual-core@3.17.0/node_modules/@tanstack/virtual-core/dist/esm/index.js` (20.96 kB) |
| 4 | `chunk-BQmEC_sF.js` | 165.48 kB | PDF viewer feature (`pdfjs-dist`) | `../../node_modules/.pnpm/pdfjs-dist@5.6.205/node_modules/pdfjs-dist/web/pdf_viewer.mjs` (164.97 kB) |
| 5 | `chunk-D52lhQll.js` | 51.69 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (51.56 kB) |
| 6 | `chunk-B-_xlUGl.js` | 46.53 kB | Combobox docs page (`/components/combobox`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (17.39 kB)<br>`../../packages/angular/combobox/combobox.ts` (11.66 kB)<br>`src/app/pages/components/combobox/combobox.page.ts` (6.38 kB) |
| 7 | `chunk-CSbEsRMR.js` | 43.63 kB | Pdf Viewer docs page (`/components/pdf-viewer`) | `../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.ts` (13.07 kB)<br>`../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.runtime.ts` (9.44 kB)<br>`src/app/pages/components/pdf-viewer/pdf-viewer.page.ts` (6.22 kB) |
| 8 | `chunk-BoE1tB7w.js` | 36.11 kB | Audio Player docs page (`/components/audio-player`) | `../../packages/angular/audio-player/audio-player.ts` (16.56 kB)<br>`src/app/pages/components/audio-player/audio-player.page.ts` (8.96 kB)<br>`../../packages/angular/features/audio-transcript/audio-transcript.ts` (2.73 kB) |
| 9 | `chunk-CZvPBM14.js` | 33.18 kB | Time Input docs page (`/components/time-input`) | `../../packages/angular/time-input/time-input.ts` (15.35 kB)<br>`src/app/pages/components/time-input/time-input.page.ts` (6.44 kB)<br>`src/app/pages/components/time-input/examples/examples.example.ts?raw` (2.13 kB) |
| 10 | `chunk-9mGHnlei.js` | 32.90 kB | Field docs page (`/components/field`)<br>Date Input docs page (`/components/date-input`)<br>Date Picker docs page (`/components/date-picker`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-date-picker.mjs` (18.58 kB)<br>`../../packages/angular/date-picker/date-picker.ts` (11.77 kB)<br>`../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-date-time.mjs` (2.03 kB) |
| 11 | `chunk-CtqbiJxx.js` | 30.77 kB | Accessibility guide page | `src/app/pages/accessibility/accessibility.page.ts` (30.47 kB) |
| 12 | `chunk-BX99bHNd.js` | 30.39 kB | Dialog docs page (`/components/dialog`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-dialog.mjs` (9.65 kB)<br>`../../packages/angular/dialog/dialog.ts` (5.74 kB)<br>`src/app/pages/components/dialog/dialog.page.ts` (5.73 kB) |
