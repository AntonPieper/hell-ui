...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 926.83 kB | 500.00 kB | 1050.00 kB | accepted warning: 426.83 kB over; accepted ceiling: 930.00 kB; owner: Docs shell / global styles; follow-up: lazy-route import graph guard |
...
| Rank | Chunk | Size | Owner | Largest inputs |
| ---: | --- | ---: | --- | --- |
| 1 | `chunk-Bea35zY4.js` | 423.22 kB | Code Editor docs page (`/components/code-editor`)<br>Getting Started guide page<br>Guide guide page | `../../node_modules/.pnpm/@codemirror+view@6.41.1/node_modules/@codemirror/view/dist/index.js` (166.13 kB)<br>`../../node_modules/.pnpm/@lezer+javascript@1.5.4/node_modules/@lezer/javascript/dist/index.js` (78.32 kB)<br>`../../node_modules/.pnpm/@codemirror+state@6.6.0/node_modules/@codemirror/state/dist/index.js` (46.72 kB) |
| 2 | `chunk-BX0xE_B_.js` | 410.61 kB | PDF viewer feature (`pdfjs-dist`) | `../../node_modules/.pnpm/pdfjs-dist@5.6.205/node_modules/pdfjs-dist/build/pdf.mjs` (409.32 kB) |
| 3 | `chunk-lEkC4Y4M.js` | 197.94 kB | Table docs page (`/components/table`) | `../../node_modules/.pnpm/@tanstack+table-core@8.21.3/node_modules/@tanstack/table-core/build/lib/index.mjs` (53.02 kB)<br>`src/app/pages/components/table/examples/tanstack-shell.example.ts?raw` (22.94 kB)<br>`../../node_modules/.pnpm/@tanstack+virtual-core@3.17.0/node_modules/@tanstack/virtual-core/dist/esm/index.js` (20.96 kB) |
| 4 | `chunk-DLLCfdS_.js` | 165.48 kB | PDF viewer feature (`pdfjs-dist`) | `../../node_modules/.pnpm/pdfjs-dist@5.6.205/node_modules/pdfjs-dist/web/pdf_viewer.mjs` (164.97 kB) |
| 5 | `chunk-BLBSZn5K.js` | 51.69 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (51.56 kB) |
| 6 | `chunk-CM567Pqk.js` | 46.53 kB | Combobox docs page (`/components/combobox`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (17.39 kB)<br>`../../packages/angular/combobox/combobox.ts` (11.66 kB)<br>`src/app/pages/components/combobox/combobox.page.ts` (6.38 kB) |
| 7 | `chunk-jL4hywOs.js` | 43.63 kB | Pdf Viewer docs page (`/components/pdf-viewer`) | `../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.ts` (13.07 kB)<br>`../../packages/pdf-viewer/src/lib/pdf-viewer/pdf-viewer.runtime.ts` (9.44 kB)<br>`src/app/pages/components/pdf-viewer/pdf-viewer.page.ts` (6.22 kB) |
| 8 | `chunk-DCstamvx.js` | 36.11 kB | Audio Player docs page (`/components/audio-player`) | `../../packages/angular/audio-player/audio-player.ts` (16.56 kB)<br>`src/app/pages/components/audio-player/audio-player.page.ts` (8.96 kB)<br>`../../packages/angular/features/audio-transcript/audio-transcript.ts` (2.73 kB) |
| 9 | `chunk-elULYdcH.js` | 33.18 kB | Time Input docs page (`/components/time-input`) | `../../packages/angular/time-input/time-input.ts` (15.35 kB)<br>`src/app/pages/components/time-input/time-input.page.ts` (6.44 kB)<br>`src/app/pages/components/time-input/examples/examples.example.ts?raw` (2.13 kB) |
| 10 | `chunk-ByHC30eS.js` | 32.90 kB | Field docs page (`/components/field`)<br>Date Input docs page (`/components/date-input`)<br>Date Picker docs page (`/components/date-picker`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-date-picker.mjs` (18.58 kB)<br>`../../packages/angular/date-picker/date-picker.ts` (11.77 kB)<br>`../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-date-time.mjs` (2.03 kB) |
| 11 | `chunk-Be--3Auy.js` | 31.64 kB | Accessibility guide page | `src/app/pages/accessibility/accessibility.page.ts` (31.33 kB) |
| 12 | `chunk-C93N6nXC.js` | 30.39 kB | Dialog docs page (`/components/dialog`) | `../../node_modules/.pnpm/ng-primitives@0.123.0_2d92e22ef8f64707773e19771a48aacc/node_modules/ng-primitives/fesm2022/ng-primitives-dialog.mjs` (9.65 kB)<br>`../../packages/angular/dialog/dialog.ts` (5.74 kB)<br>`src/app/pages/components/dialog/dialog.page.ts` (5.73 kB) |
...
| --- | --- | --- | --- |
| Initial bundle exceeds 500 kB by 426.83 kB | Static imports from `main` pull router/runtime plus docs-shell controls; `styles.css` globally imports Tailwind and explicit Hell entrypoint styles. Top chunks: `main-JTRI4GER.js`, `styles-RMTBMVS2.css`. | Docs shell / global styles | Accepted by the docs budget policy (lazy-route import graph guard; expires when: Any build that exceeds the accepted ceiling, reaches the initial maximumError threshold, or reopens the production-readiness budget decision.); the architecture guard blocks future eager imports across docs route boundaries, and any undocumented new warning is a regression. |
