...
| 9 | `main-BXY2IKR5.js` | 22.32 kB | Docs app shell bootstrap | `src/app/app.ts` (19.84 kB)<br>`src/app/shared/lazy-global-style.ts` (175 B)<br>`src/app/app.config.ts` (74 B) |
...
| 7 | `chunk-4C4U3ZLU.js` | 41.65 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (41.42 kB) |
