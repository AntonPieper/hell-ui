...
| 9 | `main-B5JA7W76.js` | 22.32 kB | Docs app shell bootstrap | `src/app/app.ts` (19.84 kB)<br>`src/app/shared/lazy-global-style.ts` (175 B)<br>`src/app/app.config.ts` (74 B) |
...
| 7 | `chunk-2K3GFQIZ.js` | 40.82 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (40.59 kB) |
