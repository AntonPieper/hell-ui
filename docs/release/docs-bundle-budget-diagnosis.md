...
| 9 | `main-IG6W6V3Y.js` | 22.32 kB | Docs app shell bootstrap | `src/app/app.ts` (19.84 kB)<br>`src/app/shared/lazy-global-style.ts` (175 B)<br>`src/app/app.config.ts` (74 B) |
...
| 7 | `chunk-LD5TXO2X.js` | 42.08 kB | Docs search index (loaded on search open) | `src/app/docs-search-index.ts` (41.85 kB) |
