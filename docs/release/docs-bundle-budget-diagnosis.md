...
| --- | ---: | ---: | ---: | --- |
| Initial bundle | 777.73 kB | 500.00 kB | 1050.00 kB | accepted warning: 277.73 kB over; accepted ceiling: 778.00 kB; owner: Docs shell / global styles; follow-up: HELL-050 static guard |
...
| ---: | --- | ---: | --- | --- |
| 1 | `styles-QRIHUAXJ.css` | 169.56 kB | Docs global stylesheet (`styles.css`) | `projects/hell-docs/src/styles.css` (169.56 kB)<br>`angular:styles/global:styles` (0 B) |
...
| 4 | `chunk-AAXY3DRY.js` | 73.94 kB | Docs search / omnibar shell | `node_modules/@angular/cdk/fesm2022/_overlay-module-chunk.mjs` (39.50 kB)<br>`dist/hell/fesm2022/hell-ui-angular-omnibar.mjs` (33.32 kB)<br>`node_modules/@angular/cdk/fesm2022/_test-environment-chunk.mjs` (138 B) |
| 5 | `chunk-NDR55HFK.js` | 45.99 kB | Docs shell primitive dependencies | `node_modules/@angular/cdk/fesm2022/_a11y-module-chunk.mjs` (7.96 kB)<br>`node_modules/@angular/cdk/fesm2022/_focus-monitor-chunk.mjs` (6.22 kB)<br>`node_modules/ng-primitives/fesm2022/ng-primitives-interactions.mjs` (5.95 kB) |
...
| 7 | `chunk-FAU5Q5X2.js` | 39.22 kB | Docs shell primitive dependencies | `node_modules/ng-primitives/fesm2022/ng-primitives-portal.mjs` (20.79 kB)<br>`node_modules/@floating-ui/dom/dist/floating-ui.dom.mjs` (7.06 kB)<br>`node_modules/@floating-ui/core/dist/floating-ui.core.mjs` (7.00 kB) |
| 8 | `chunk-OCARF3M5.js` | 22.22 kB | Docs theme filter select shell | `node_modules/ng-primitives/fesm2022/ng-primitives-select.mjs` (10.77 kB)<br>`dist/hell/fesm2022/hell-ui-angular-select.mjs` (10.70 kB) |
| 9 | `main-6WYRITGZ.js` | 21.47 kB | Docs app shell bootstrap | `projects/hell-docs/src/app/app.ts` (19.60 kB)<br>`projects/hell-docs/src/app/app.config.ts` (74 B)<br>`projects/hell-docs/src/main.ts` (35 B) |
| 10 | `chunk-VJ3LVA6D.js` | 20.69 kB | Docs shell primitive dependencies | `node_modules/@angular/forms/fesm2022/forms.mjs` (20.36 kB) |
| 11 | `chunk-U4SVJJZ3.js` | 18.43 kB | Docs menu shell | `node_modules/ng-primitives/fesm2022/ng-primitives-menu.mjs` (12.11 kB)<br>`dist/hell/fesm2022/hell-ui-angular-menu.mjs` (5.72 kB) |
| 12 | `chunk-B6RT6UTY.js` | 16.29 kB | Docs app-shell layout | `dist/hell/fesm2022/hell-ui-angular-app-shell.mjs` (15.91 kB)<br>`node_modules/@angular/cdk/fesm2022/layout.mjs` (0 B) |
...
| 2 | `chunk-UWWNMPVA.js` | 301.73 kB | Code Editor docs page (`/components/code-editor`)<br>Omnibar docs page (`/components/omnibar`)<br>Getting Started guide page | `node_modules/@codemirror/view/dist/index.js` (164.96 kB)<br>`node_modules/@codemirror/state/dist/index.js` (46.36 kB)<br>`node_modules/@codemirror/language/dist/index.js` (23.36 kB) |
| 3 | `chunk-NDY7HXA3.js` | 163.92 kB | PDF viewer feature (`pdfjs-dist`) | `node_modules/pdfjs-dist/web/pdf_viewer.mjs` (163.41 kB) |
| 4 | `chunk-7RJYNHHG.js` | 141.14 kB | Table utilities docs page (`/components/data-table`) | `dist/hell/fesm2022/hell-ui-angular-data-table.mjs` (43.94 kB)<br>`projects/hell-docs/src/app/pages/components/data-table/examples/example.example.ts?raw` (34.09 kB)<br>`projects/hell-docs/src/app/pages/components/data-table/examples/example.example.ts` (23.27 kB) |
| 5 | `chunk-VR7NL6IT.js` | 128.05 kB | Code Editor docs page (`/components/code-editor`) | `node_modules/@lezer/javascript/dist/index.js` (77.72 kB)<br>`node_modules/@lezer/lr/dist/index.js` (26.49 kB)<br>`node_modules/@codemirror/autocomplete/dist/index.js` (7.56 kB) |
| 6 | `chunk-LYIEGFZH.js` | 46.15 kB | Audio Player docs page (`/components/audio-player`) | `dist/hell/fesm2022/hell-ui-angular-audio-player.mjs` (31.96 kB)<br>`projects/hell-docs/src/app/pages/components/audio-player/audio-player.page.ts` (7.13 kB)<br>`dist/hell/fesm2022/hell-ui-angular-features-audio-transcript.mjs` (2.83 kB) |
| 7 | `chunk-LVGNQV6H.js` | 40.72 kB | Combobox docs page (`/components/combobox`) | `node_modules/ng-primitives/fesm2022/ng-primitives-combobox.mjs` (16.69 kB)<br>`dist/hell/fesm2022/hell-ui-angular-combobox.mjs` (10.85 kB)<br>`projects/hell-docs/src/app/pages/components/combobox/combobox.page.ts` (3.90 kB) |
| 8 | `chunk-BCUWHWNH.js` | 37.17 kB | Docs search index (loaded on search open) | `projects/hell-docs/src/app/docs-search-index.ts` (36.95 kB) |
| 9 | `chunk-DRUE4BLD.js` | 36.08 kB | Time Input docs page (`/components/time-input`) | `dist/hell/fesm2022/hell-ui-angular-time-input.mjs` (21.94 kB)<br>`projects/hell-docs/src/app/pages/components/time-input/time-input.page.ts` (4.42 kB)<br>`projects/hell-docs/src/app/pages/components/time-input/examples/examples.example.ts?raw` (1.91 kB) |
| 10 | `chunk-VSOVBHKJ.js` | 31.48 kB | Dialog docs page (`/components/dialog`) | `node_modules/ng-primitives/fesm2022/ng-primitives-dialog.mjs` (9.48 kB)<br>`dist/hell/fesm2022/hell-ui-angular-dialog.mjs` (7.23 kB)<br>`projects/hell-docs/src/app/pages/components/dialog/dialog.page.ts` (4.38 kB) |
| 11 | `chunk-ZPOYDUTP.js` | 26.97 kB | Pdf Viewer docs page (`/components/pdf-viewer`) | `dist/hell-pdf-viewer/fesm2022/hell-ui-pdf-viewer.mjs` (26.23 kB) |
| 12 | `chunk-7WY5USFJ.js` | 26.48 kB | Accessibility guide page | `projects/hell-docs/src/app/pages/accessibility/accessibility.page.ts` (26.15 kB)<br>`dist/hell/styles/components/table.css` (0 B) |
...
| --- | --- | --- | --- |
| Initial bundle exceeds 500 kB by 277.73 kB | Static imports from `main` pull router/runtime plus docs-shell controls; `styles.css` globally imports Tailwind and `@hell-ui/angular/styles/composites`. Top chunks: `styles-QRIHUAXJ.css`, `chunk-VNJZG7G7.js`, `chunk-RGKQF2RW.js`, `chunk-AAXY3DRY.js`, `chunk-NDR55HFK.js`. | Docs shell / global styles | Accepted by the docs budget policy (HELL-050 static guard); HELL-050 guards future eager imports across docs route boundaries, and any undocumented new warning is a regression. |
