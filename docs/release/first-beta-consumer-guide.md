...
| TanStack table shell          | Core peer group plus `tailwindcss` and optional `@tanstack/angular-table`; no `@tanstack/virtual-core`                                          | `hell-ui/table-tanstack`; caller-owned TanStack Table remains the engine; CSS from `hell-ui/table-tanstack/styles.css`, which imports the primitive table styles and carries the pinned-column rules                                                                                                                                                 | [`table-tanstack`](../../tools/consumer-fixtures/README.md)                              |
