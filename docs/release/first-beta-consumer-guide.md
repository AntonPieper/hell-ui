...
- Critical accessibility gaps still block a production-ready claim for several public surfaces, including date input, radio, slider, switch, tabs, tooltip, and omnibar.
