...
- Critical accessibility gaps still block a production-ready claim for several public surfaces, including date input, slider, switch, tabs, tooltip, and omnibar.
