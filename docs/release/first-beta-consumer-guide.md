...
- Critical accessibility gaps still block a production-ready claim for several public surfaces, including date input, listbox, popover, radio, slider, switch, tabs, tooltip, and omnibar.
