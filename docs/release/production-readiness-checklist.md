...
| ---------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Package-consumer | `pnpm test:package-consumer -- --minimal-deps`; `pnpm release:dry-run -- --full` | Full release JSON evidence must show selected strict-peer consumer scenarios passing (`root-core`, `button-ui`, `button`, `primitive-icons-css`, `audio-player`, `audio-transcript`, `table`, `table-tanstack`, `table-tanstack-virtual`, `no-legacy-alias`, `code-editor`, `pdf-viewer`).                   |
