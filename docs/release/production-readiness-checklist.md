...
| --- | --- | --- | --- |
| Package-consumer | HELL-012, HELL-020, HELL-021, HELL-022, HELL-023, HELL-024 | `pnpm test:package-consumer -- --minimal-deps`; `pnpm release:dry-run -- --full` | Full release JSON evidence must show selected strict-peer consumer scenarios passing (`root-core`, `button-unstyled`, `primitives-css`, `code-editor`). |
