...
const RULES = [
  ...
  rule('hellNativeSelect', 'HellNativeSelect'),
  groupRule('hellSelect', 'HELL_SELECT_DIRECTIVES'),
  groupRule('hellSelectValue', 'HELL_SELECT_DIRECTIVES'),
  groupRule('hellSelectPlaceholder', 'HELL_SELECT_DIRECTIVES'),
  groupRule('hellSelectDropdown', 'HELL_SELECT_DIRECTIVES'),
  groupRule('hellSelectPortal', 'HELL_SELECT_DIRECTIVES'),
  groupRule('hellSelectOption', 'HELL_SELECT_DIRECTIVES'),
  groupRule('hellCombobox', 'HELL_COMBOBOX_DIRECTIVES'),
  groupRule('hellComboboxInput', 'HELL_COMBOBOX_DIRECTIVES'),
  groupRule('hellComboboxButton', 'HELL_COMBOBOX_DIRECTIVES'),
  groupRule('hellComboboxDropdown', 'HELL_COMBOBOX_DIRECTIVES'),
  groupRule('hellComboboxPortal', 'HELL_COMBOBOX_DIRECTIVES'),
  groupRule('hellComboboxOption', 'HELL_COMBOBOX_DIRECTIVES'),
  groupRule('hellComboboxEmpty', 'HELL_COMBOBOX_DIRECTIVES'),
