...
//
// types/hell-ui-table-tanstack-virtual.d.ts:8:5 - (ae-undocumented) Missing documentation for "enabled".
// types/hell-ui-table-tanstack-virtual.d.ts:9:5 - (ae-undocumented) Missing documentation for "estimateRowSize".
// types/hell-ui-table-tanstack-virtual.d.ts:10:5 - (ae-undocumented) Missing documentation for "overscan".
// types/hell-ui-table-tanstack-virtual.d.ts:22:5 - (ae-undocumented) Missing documentation for "totalSize".
// types/hell-ui-table-tanstack-virtual.d.ts:23:5 - (ae-undocumented) Missing documentation for "rowWidth".
// types/hell-ui-table-tanstack-virtual.d.ts:26:5 - (ae-undocumented) Missing documentation for "rows".
// types/hell-ui-table-tanstack-virtual.d.ts:27:5 - (ae-undocumented) Missing documentation for "connectScrollport".
// types/hell-ui-table-tanstack-virtual.d.ts:28:5 - (ae-undocumented) Missing documentation for "connectBody".
// types/hell-ui-table-tanstack-virtual.d.ts:29:5 - (ae-undocumented) Missing documentation for "connectRow".
// types/hell-ui-table-tanstack-virtual.d.ts:30:5 - (ae-undocumented) Missing documentation for "ngOnDestroy".
