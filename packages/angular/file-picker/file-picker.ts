...
const HELL_FILE_PICKER_RECIPE = {
  root: 'flex min-h-[140px] cursor-pointer select-none flex-col items-center justify-center gap-hell-3 rounded-hell-lg border-[1.5px] border-dashed border-hell-border-strong bg-hell-surface-subtle p-hell-7 text-center text-hell-foreground-muted transition-[background-color,border-color,color] duration-[var(--hell-duration-fast)] ease-hell-out outline-none hover:border-hell-primary hover:bg-hell-primary-soft/50 hover:text-hell-foreground focus-visible:border-hell-primary focus-visible:outline-2 focus-visible:outline-hell-focus-ring focus-visible:outline-offset-2 data-[dragging=true]:border-solid data-[dragging=true]:border-hell-primary data-[dragging=true]:bg-hell-primary-soft data-[dragging=true]:text-hell-primary data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-60 data-[disabled=true]:hover:border-hell-border-strong data-[disabled=true]:hover:bg-hell-surface-subtle data-[disabled=true]:hover:text-hell-foreground-muted',
