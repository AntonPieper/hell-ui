...
} satisfies HellRecipe<HellChipRemovePart>;
...
export class HellChip {
  ...
  protected readonly part = hellPartStyler<HellChipPart>(this.ui, {
    defaultPart: 'root',
    recipe: (): HellRecipe<HellChipPart> => ({
      root: `${HELL_CHIP_BASE_RECIPE} ${HELL_CHIP_SIZE_RECIPE[this.size()]}`,
    }),
  });
...
export class HellChipRemove {
  ...
  protected readonly part = hellPartStyler<HellChipRemovePart>(this.ui, {
    defaultPart: 'root',
    recipe: () => HELL_CHIP_REMOVE_RECIPE,
  });
