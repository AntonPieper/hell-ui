...
const HELL_TOGGLE_SELECTED_RECIPE =
  'hover:bg-hell-surface-muted active:bg-hell-surface-muted active:scale-[0.97] data-selected:border-hell-primary data-selected:bg-hell-primary data-selected:text-hell-primary-foreground data-selected:hover:border-hell-primary-hover data-selected:hover:bg-hell-primary-hover data-[selected][data-hover]:border-hell-primary-hover data-[selected][data-hover]:bg-hell-primary-hover';
