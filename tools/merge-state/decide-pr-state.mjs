...
// reports the fixture-tested policy verdict from tools/merge-state/pr-state-policy.mjs.
...
const usage =
  'Usage: node tools/merge-state/decide-pr-state.mjs --labels <labels.json> --files <files.json> --pull <pull.json>';
