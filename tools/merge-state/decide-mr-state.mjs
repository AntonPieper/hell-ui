...
// adapter (tools/merge-state/mr-state-input.mjs), and reports the policy verdict from
// tools/merge-state/pr-state-policy.mjs. Dependency-free on purpose, like the policy: the
