...
} from '../build/workspace-versions.mjs';
...
function assertFixtureManifest(fixture) {
  ...
  if (!(manifest.peerGroup in peerGroupContracts)) {
    fail(
      `Fixture ${fixture.name} fixture.json needs a peerGroup from tools/package/package-pack-audit.mjs, got ${JSON.stringify(manifest.peerGroup)}`,
    );
  }
