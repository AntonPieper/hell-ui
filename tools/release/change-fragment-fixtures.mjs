...
// command (tools/release/release-changelog.mjs), so it is not replayed here. Nothing
...
import { runNamedFixtures } from '../harness/fixture-harness.mjs';
...
// (tools/release/change-fragments.mjs) agree: a kind the validator would reject must
