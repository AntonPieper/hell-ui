...
// tools/release/release-projection.mjs and asserts the explicit pass/fail decision.
...
import { collectExpectationFailures, runNamedFixtures } from '../harness/fixture-harness.mjs';
import {
