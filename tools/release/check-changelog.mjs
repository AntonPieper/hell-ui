...
function collectCommandSurfaceErrors() {
  ...
  if (scripts['release:prepare'] !== 'node tools/release/release-prepare.mjs') {
    surfaceErrors.push(
      'package.json must keep `release:prepare: "node tools/release/release-prepare.mjs"` as the one Release Preparation command.',
    );
  }
