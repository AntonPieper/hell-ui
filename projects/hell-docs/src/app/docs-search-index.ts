...
const HD_DOCS_EXAMPLES: readonly DocsSearchSeed[] = [
  ...
  },
  {
    ...
    terms: 'table primitive components/table/examples/primitive-table.example components/table hellTable HELL_TABLE_UTILITIES_DIRECTIVES native table sort trigger resize handle row action selection controls',
  },
  {
    title: 'Table: TanStack Shell',
    path: '/components/table',
    detail: 'components/table/examples/tanstack-shell.example.ts',
    terms: 'table tanstack shell components/table/examples/tanstack-shell.example components/table hell-tanstack-table HellTanStackTable HellTableStatus hellTableShellCell hellTableShellToolbar hellTableShellFooter pagination filtering flexRender',
  },
  {
    title: 'Table: TanStack Virtual Rows',
    path: '/components/table',
    detail: 'components/table/examples/tanstack-virtual.example.ts',
    terms: 'table tanstack virtual rows components/table/examples/tanstack-virtual.example components/table @hell-ui/angular/table-tanstack/virtual hellTanStackVirtualRows HellTanStackVirtualRows hellTableShellExpandedRow expanded rows TanStack Virtual',
  },
  {
