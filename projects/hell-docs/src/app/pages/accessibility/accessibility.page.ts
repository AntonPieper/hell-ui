...
const A11Y_MATRIX: readonly AccessibilityMatrixRow[] = [
  ...
  },
  {
    ...
    rolePattern: 'Native table markup with sortable header buttons, optional selectable rows, and role=separator resize handles.',
    keyboardCoverage: 'Browser behavior covers resize-handle ArrowRight and nested row controls avoiding row selection.',
