...
@Component({
  ...
  template: `
    <article class="hd-prose">
      ...
      <hd-example-tabs [code]="exampleCodes[0]" previewClass="grid max-w-md gap-4">
        <div hellField>
      ...
      <hd-example-tabs [code]="exampleCodes[1]" previewClass="grid max-w-md gap-2">
...
export class FieldPage {
  protected readonly exampleCodes = [
    '<div hellField>\n  <label hellFieldLabel>Email</label>\n  <input hellInput type="email" placeholder="you@company.com" />\n  <div hellFieldDescription>We never share this.</div>\n</div>\n\n<div hellField>\n  <label hellFieldLabel>Password</label>\n  <input hellInput type="password" invalid />\n  <div hellFieldError>Use at least 12 characters.</div>\n</div>\n',
    '<div hellField orientation="horizontal">\n  <button hellCheckbox></button>\n  <label hellFieldLabel>I agree to the terms</label>\n  <div hellFieldDescription>You can opt out later.</div>\n</div>\n',
  ] as const;
