...
@Component({
  ...
  imports: [ExampleTabs, HellToggle, HellToggleGroup, HellToggleGroupItem],
  template: `
    <article class="hd-prose">
      ...
      <h2>Single toggle</h2>
      <hd-example-tabs [code]="exampleCodes[0]" previewClass="flex gap-2">
        ...
        <button
          hellToggle
          [selected]="italic()"
          (selectedChange)="italic.set($event)"
          type="button"
        >
          <em>I</em>
        </button>
      ...
      <hd-example-tabs [code]="exampleCodes[2]">
        <div
          ...
          type="multiple"
          [value]="tools()"
          (valueChange)="tools.set($any($event))"
        >
      ...
      <h2>Disabled</h2>
      <hd-example-tabs [code]="exampleCodes[3]" previewClass="flex gap-2">
...
export class TogglePage {
  protected readonly exampleCodes = [
    '<button hellToggle selected type="button">\n  <strong>B</strong>\n</button>\n<button hellToggle type="button">\n  <em>I</em>\n</button>\n<button hellToggle type="button">\n  <u>U</u>\n</button>\n',
    '<div hellToggleGroup type="single" value="center">\n  <button hellToggleGroupItem value="left" type="button">Left</button>\n  <button hellToggleGroupItem value="center" type="button">Center</button>\n  <button hellToggleGroupItem value="right" type="button">Right</button>\n</div>\n',
    '<div hellToggleGroup type="multiple">\n  <button hellToggleGroupItem value="bold" type="button">Bold</button>\n  <button hellToggleGroupItem value="italic" type="button">Italic</button>\n  <button hellToggleGroupItem value="underline" type="button">Underline</button>\n</div>\n',
    '<button hellToggle size="xs" type="button">XS</button>\n<button hellToggle size="sm" type="button">SM</button>\n<button hellToggle size="md" type="button">MD</button>\n<button hellToggle size="lg" type="button">LG</button>\n<button hellToggle size="xl" type="button">XL</button>\n',
  ] as const;
